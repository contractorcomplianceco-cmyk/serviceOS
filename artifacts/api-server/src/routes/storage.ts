...
router.get(
  ...
  try {
    ...
    // Download authorization: the file must belong to the caller's tenant, and
    // the caller's role must satisfy the file's visibility. Metadata lives in
    // the files table keyed by normalized objectPath.
